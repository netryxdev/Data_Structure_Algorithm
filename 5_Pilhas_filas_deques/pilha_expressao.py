...
class pilha:
    def __init__(self, capacidade):
        self.capacidade = capacidade # Colocamos esse __ antes da variavel para que ela fique privada por segurança.
        self.topo = -1
        # Array de chars (b'(')
        self.valores = np.chararrayr(self.capacidade, unicode=True)
